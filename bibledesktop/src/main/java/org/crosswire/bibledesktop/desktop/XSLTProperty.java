...
public enum XSLTProperty {
   ...
   MORPH("Morph", false),
    ...
    /**
     * Should glosses be shown as Ruby annotations
     */
    GLOSS("Gloss", true),
     ...
     */
    XSLTProperty(String name, boolean defaultState) {
     ...
     *            The initial state of the property.
     */
    XSLTProperty(String name, String defaultState) {
     ...
     *            The initial state of the property.
     */
    XSLTProperty(String name, String defaultState, boolean asURL) {
        this.name = name;
