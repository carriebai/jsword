...
//      cwAction.setAccelerator("V,ctrl");
        ...
        // TRANSLATOR: This is the label for the checkbox to show/hide Glosses such as Japanese Ruby
        cwAction = actions.addAction(XSLTProperty.GLOSS.getName(), BDMsg.gettext("Show Glosses"));
...
//      menuEdit.add(actions.findAction("Paste")).addMouseListener(barStatus);
    ...
    private JMenu createViewMenu(ToolBar toolbar) {
        ...
        menu.add(createCheckbox(XSLTProperty.GLOSS)).addMouseListener(barStatus);
...
//      toolbar.add(actions.findAction("Paste")).addMouseListener(barStatus);
    ...
    private static class DesktopRunner implements Runnable {
         ...
         * @param aSplash
         */
        DesktopRunner(Desktop aDesktop, Splash aSplash) {
            desktop = aDesktop;
            splash = aSplash;
        }
